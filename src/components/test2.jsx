...
import { FiUser, FiMail, FiLock, FiUpload, FiChevronLeft, FiChevronRight } from "react-icons/fi";
        ...
        {currentStep === 1 && (
          <div className="space-y-5">
            <div className="relative">
              ...
              {errors.collegeName && (
                <p className="text-xs ml-1 mt-1 text-red-400">{errors.collegeName.message}</p>
              )}
            </div>
            <div className="relative">
              <input
              ...
              {errors.registrationToken && (
                <p className="text-xs ml-1 mt-1 text-red-400">{errors.registrationToken.message}</p>
              )}
            </div>
          </div>
        )}
        ...
        {currentStep === 2 && (
          <div className="space-y-5">
            <div className="relative">
              ...
              {errors.department && (
                <p className="text-xs ml-1 mt-1 text-red-400">{errors.department.message}</p>
              )}
            </div>
            <div className="relative">
              <select
            ...
            <div className="relative">
              ...
              {errors.rollNumber && (
                <p className="text-xs ml-1 mt-1 text-red-400">{errors.rollNumber.message}</p>
              )}
            </div>
          </div>
        )}
        ...
        {currentStep === 3 && (
          <div className="space-y-5">
            <div className="relative">
              ...
              {errors.fullName && (
                <p className="text-xs ml-1 mt-1 text-red-400">{errors.fullName.message}</p>
              )}
            </div>
            <div className="relative">
              <input
        ...
        <div className="flex justify-between mt-6">
          ...
          {currentStep < 4 ? (
            <button
              type="button"
              onClick={handleNext}
              className="px-4 py-2 rounded-lg bg-[#155dfc] text-white hover:bg-[#1447e6] transition"
            >
